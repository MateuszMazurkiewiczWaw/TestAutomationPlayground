@Sprint2
Feature: HOL-20233 Category Page Fold out - Subchapter 3rd level

  Scenario Outline: Category Page Fold out - Subchapter 3rd level
		...
		And General: Wait 2 seconds
		Then Webshop Main Page: On PRODUCT_OR_CATEGORY_LIST category <PRODUCT_CATEGORY_2ND_LEVEL> is visible
		And Webshop Main Page: Section PRODUCT_OR_CATEGORY_LIST_NAVIGATION_BAR not contains text <PRODUCT_CATEGORY_1ST_LEVEL>
		And Webshop Main Page: Section PRODUCT_OR_CATEGORY_LIST_NAVIGATION_BAR contains text <PRODUCT_CATEGORY_2ND_LEVEL>
		And Webshop Main Page: PRODUCT_OR_CATEGORY_LIST contains more than 1 PRODUCT_OR_CATEGORY_NAMES
		...
		Then Webshop Main Page: PRODUCT_OR_CATEGORY_LIST is visible
		And Webshop Main Page: Section PRODUCT_OR_CATEGORY_LIST_NAVIGATION_BAR contains text headerstaticcomponent.label.products
		And Webshop Main Page: Section PRODUCT_OR_CATEGORY_LIST_NAVIGATION_BAR not contains text <PRODUCT_CATEGORY_2ND_LEVEL>
		And Webshop Main Page: PRODUCT_OR_CATEGORY_LIST contains more than 1 PRODUCT_OR_CATEGORY_NAMES
		...
		And Webshop Main Page: In section PRODUCT_OR_CATEGORY_LIST element WANT_TO_KNOW_MORE_3RD_LEVEL_BUTTON is visible
		#TO-DO
	...
	Examples:
      ...
      |	US_Product_Category_1st_Level1	| US_Product_Category_2nd_Level1	|