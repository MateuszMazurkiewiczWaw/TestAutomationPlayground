@Sprint4
Feature: HOL-22543 and HOL-20481 Software and Standard - Billing information

  Scenario Outline: Software and Standard - Content of the page and all functionalities of the billing page
		...
		And Checkout Billing Page: In section BILLING_INFORMATION_FORM element DELIVERY_INFORMATION_BREADCRUMB is visible
	...
	Examples:
      ...
      |	US_user_email			|	US_user_password	|	US_user_name	|	US_user_id		|	US_software_product1    |	US_standard_product2	|