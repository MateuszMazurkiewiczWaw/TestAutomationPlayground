...
public class MyFavoriteListsDetailsPage extends Page{
	...
	public enum FieldName implements Storable {
		...
		FAVORITE_LIST_PRODUCTS_TABLE, //section
		ADD_TO_LIST_BUTTON,
		...
		FLEET_RADIOBUTTON, 
		BUY_RADIOBUTTON,
		FLEET_RADIOBUTTON_LABEL, 
		BUY_RADIOBUTTON_LABEL,
		ADD_TO_CART_ROW_BUTTON,
		PRODUCT_QUANTITY_IN_ROW
		
	}
	
	public MyFavoriteListsDetailsPage(){
		...
		addField(FieldName.FAVORITE_LIST_PRODUCTS_TABLE, new Field(FieldType.DIV, By.xpath("//div[contains(@class,'o-favorite-list favoritelist_')]")));
		...
		addField(FieldName.FLEET_RADIOBUTTON, new Field(FieldType.RADIO, By.xpath(".//label[contains(@for,'radio-product') and contains(@for,'fleet')]//parent::div/input")));
		addField(FieldName.BUY_RADIOBUTTON, new Field(FieldType.RADIO, By.xpath(".//label[contains(@for,'radio-product') and not(contains(@for,'fleet'))]//parent::div/input")));
		addField(FieldName.FLEET_RADIOBUTTON_LABEL, new Field(FieldType.RADIO, By.xpath(".//div[contains(@id,'radio-product') and (contains(@id,'fleet-div'))]")));
		addField(FieldName.BUY_RADIOBUTTON_LABEL, new Field(FieldType.RADIO, By.xpath(".//div[contains(@id,'radio-product') and (contains(@id,'buy-div'))]")));
		...
		addField(FieldName.PRODUCT_QUANTITY_IN_ROW, new Field(FieldType.DIV, By.xpath(".//input[@name='quantity']")));
