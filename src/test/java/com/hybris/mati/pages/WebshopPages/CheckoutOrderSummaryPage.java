...
public class CheckoutOrderSummaryPage extends Page{
	...
	public CheckoutOrderSummaryPage(){
		...
		addField(FieldName.EDIT_BILLING_INFORMATION_BUTTON, new Field(FieldType.BUTTON, By.xpath(".//a[@class='a-link-action a-icon-edit a-color-hybris-red-before no-print']")));
