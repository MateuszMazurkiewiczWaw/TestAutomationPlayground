...
public class FirestopsBuilderPage extends Page{
	...
	public FirestopsBuilderPage(){
		...
		addField(FieldName.hybris_COVER_PAGE_RADIOBUTTON, new Field(FieldType.RADIO, By.xpath(".//div[@class='a-radio ' and contains(@id, 'hybrisCover')]")));
