...
public class CheckoutDeliveryPage extends Page{
	...
	public enum FieldName implements Storable {
		...
		TAX_EXEMPT_POPUP,
		SHIP_TO_A_hybris_CENTER_RADIOBUTTON, // in DELIVERY_ADDRESS_FORM section
		STORELOCATOR_POPUP,
		...
		FIND_hybris_CENTER_TEXTFIELD, //On find hybris center popup
		SEARCH_hybris_CENTER_BUTTON,
		SELECTED_hybris_STORE_ADDRESS,
	...
	public CheckoutDeliveryPage(){
		...
		addField(FieldName.SHIP_TO_A_hybris_CENTER_RADIOBUTTON, new Field(FieldType.RADIO, By.id("hybrisCenterAddress-div")));
		...
		addField(FieldName.SELECT_hybris_CENTER_BUTTON, new Field(FieldType.BUTTON, By.xpath("(.//button[contains(@class, 'js-map-storeselector')])[1]")));
		...
		addField(FieldName.FIND_hybris_CENTER_TEXTFIELD, new Field(FieldType.TEXT, By.id("storelocator_deliveryinformation_input")));
		addField(FieldName.SEARCH_hybris_CENTER_BUTTON, new Field(FieldType.BUTTON, By.id("storelocator_deliveryinformation_submit")));
		addField(FieldName.SELECTED_hybris_STORE_ADDRESS, new Field(FieldType.TEXT, By.xpath(".//span[@id='storelocator_deliveryinformation_selectedstore']")));
		addField(FieldName.CHANGE_hybris_CENTER_BUTTON, new Field(FieldType.BUTTON, By.xpath(".//span[contains(@class, 'js-change-hybris-center')]")));
