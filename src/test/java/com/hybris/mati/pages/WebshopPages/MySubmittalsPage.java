...
public class MySubmittalsPage extends Page{
	...
	public MySubmittalsPage(){
		...
		addField(FieldName.DELETE_LIST_BUTTON, new Field(FieldType.BUTTON, By.xpath(".//td[@data-mapping='delete']//a[@class='a-link-action a-icon-delete a-color-hybris-red-before js-table-delete']")));
