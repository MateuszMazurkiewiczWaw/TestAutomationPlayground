package com.hilti.tahilti.steps;

import static com.hilti.functions.ClickFunctions.clickIn;
import static com.hilti.functions.MainFunctions.waitForElementInSection;
import static com.hilti.functions.MainFunctions.waitForNSeconds;
...
import com.hilti.functions.BrowserFunctions;
import com.hilti.functions.ClickFunctions;
import com.hilti.functions.MainFunctions;
import com.hilti.tahilti.pages.WebshopPages.WebshopMainPage;
...
public class ClickSteps {
    ...
    private static void verifyLocation(String pageName){
    	...
    	if (getRequiredPage(pageName).getField("LOCATION_ERROR_MESSAGE").isDisplayed()){
			getRequiredPage(pageName).getFieldWebElementsValue("FIND_HILTI_CENTER_TEXTFIELD").sendKeys("Feldkircher Strasse 100, 9494 Schaan, Liechtenstein");
			getRequiredPage(pageName).getFieldWebElementsValue("SEARCH_HILTI_CENTER_BUTTON").click();
