...
public class WebshopMainPage extends Page{
	...
	public WebshopMainPage(){
		...
		addField(FieldName.HILTI_LOGO_BUTTON, new Field(FieldType.BUTTON, By.xpath("//a//img[contains(@src, 'logo')]")));
		...
		addField(FieldName.FIND_HILTI_STORE_BUTTON, new Field(FieldType.BUTTON, By.xpath(".//a[contains(@class,'a-button-secondary')]")));
		...
		addField(FieldName.FIND_A_HILTI_CENTER_LINK, new Field(FieldType.BUTTON, By.xpath(".//a[@href='/stores']")));
