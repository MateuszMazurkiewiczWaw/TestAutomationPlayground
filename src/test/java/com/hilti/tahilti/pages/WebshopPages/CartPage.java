...
public class CartPage extends Page{
	...
	public enum FieldName implements Storable {
		...
		SELECTED_HILTI_CENTER,
		HILTI_CENTER_ADDRESS_COLUMN,
		HILTI_CENTER_OPENING_HOURS_COLUMN,
		STORE_LOCATOR_TEXTFIELD,
		SECOND_HILTI_CENTER_NAME,
		SELECT_HILTI_CENTER_OVERLAY_BUTTON, //used to open the overlay on cart page
		CURRENTLY_OPENED_HILTI_CENTER,
	...
	public CartPage(){
		...
		addField(FieldName.MANAGE_HILTI_TOOLS_LINK, new Field(FieldType.LINK, By.id("LearnRegisterLink4")));
		...
		addField(FieldName.LEARN_MORE, new Field(FieldType.LINK, By.xpath("//a[contains(@href, 'hilti.com') and contains(@class, 'a-display-block')]")));
		...
		addField(FieldName.SELECT_HILTI_CENTER_OVERLAY_BUTTON, new Field(FieldType.BUTTON, By.xpath("//a[@class='a-button-tertiary js-selected-store-link']")));
		...
		addField(FieldName.SELECTED_HILTI_CENTER, new Field(FieldType.SECTION, By.xpath("//span[@class='selected-store-text']")));
		addField(FieldName.HILTI_CENTER_ADDRESS_COLUMN, new Field(FieldType.SECTION, By.xpath("(//dl[contains (@class, 'column') and contains(., 'Address')])[2]")));
		addField(FieldName.HILTI_CENTER_OPENING_HOURS_COLUMN, new Field(FieldType.SECTION, By.xpath("(//dl[contains (@class, 'column') and contains(., 'Opening')])[2]")));
        ...
        addField(FieldName.CURRENTLY_OPENED_HILTI_CENTER, new Field(FieldType.DIV, By.xpath("//li[contains(@class, 'is-open')]")));
		...
		addField(FieldName.OVERLAY_HILTI_CENTER_MAP, new Field(FieldType.DIV, By.xpath(".//div[contains(@class, 'm-wrapper')]//div[contains(@class, 'a-map-wrapper')]")));
